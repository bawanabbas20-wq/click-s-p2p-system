        ...
        <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
            ...
            <form method="POST" action="{{ route('admin.users.update', $user) }}">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone', $user->phone)" placeholder="e.g., +1234567890" />
                </div>
                ...
                <div class="mt-4">
                    ...
                    <select name="role" id="role" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-brand-green focus:ring focus:ring-brand-green/20">
                        ...
                        <option value="procurement" {{ old('role', $user->role) == 'procurement' ? 'selected' : '' }}>{{ __('Procurement') }}</option>
                        <option value="finance" {{ old('role', $user->role) == 'finance' ? 'selected' : '' }}>{{ __('Finance') }}</option>
