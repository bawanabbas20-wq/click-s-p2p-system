<div x-show="sidebarOpen" class="fixed inset-0 flex z-50 lg:hidden" style="position: fixed !important; z-index: 9999 !important; height: 100dvh !important; top: 0 !important; left: 0 !important; right: 0 !important; bottom: 0 !important;"  
    ...
    <div class="relative flex-1 flex flex-col max-w-xs w-full p-4" 
         x-show="sidebarOpen" 
         x-transition:enter="transition ease-in-out duration-300 transform" 
         x-transition:enter-start="{{ in_array(app()->getLocale(), ['ar', 'ku']) ? 'translate-x-full' : '-translate-x-full' }}" 
         x-transition:enter-end="translate-x-0" 
         x-transition:leave="transition ease-in-out duration-300 transform" 
         x-transition:leave-start="translate-x-0" 
         x-transition:leave-end="{{ in_array(app()->getLocale(), ['ar', 'ku']) ? 'translate-x-full' : '-translate-x-full' }}">
        <div class="h-full bg-white dark:bg-gray-800 rounded-2xl shadow-lg flex flex-col p-6 w-64 transition-colors duration-200">
